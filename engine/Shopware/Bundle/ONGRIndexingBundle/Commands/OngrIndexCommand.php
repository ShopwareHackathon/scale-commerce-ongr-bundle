...
namespace Shopware\Bundle\ONGRIndexingBundle\Commands;

use Shopware\Bundle\ESIndexingBundle\Console\ConsoleProgressHelper;
use Shopware\Bundle\ONGRIndexingBundle\Product\OngrIndexer;
 ...
 */
class OngrIndexCommand extends ShopwareCommand
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var OngrIndexer $indexer */
        $indexer = $this->container->get('shopware_elastic_search.ongr_indexer');

        /** @var Shop $shop */
        foreach ($shops as $shop) {
            $output->writeln("\n## Indexing shop " . $shop->getName() . " ##");
            $indexer->populate($shop, $helper);
        }
    }
}
